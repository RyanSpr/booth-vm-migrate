...
Run this script on:
        ...
        WIN2016.AdventureWorksLT2016Copy    -  This database will be modified

to synchronize it with:

        WIN2016.AdventureWorksLT2016

You are recommended to back up your database before running this script

Script created by SQL Compare version 15.0.7.23280 from Red Gate Software Ltd at 10/29/2024 1:57:00 PM
...
GO
ALTER TABLE [SalesLT].[SalesOrderDetail] ADD CONSTRAINT [FK_SalesOrderDetail_SalesOrderHeader_SalesOrderID] FOREIGN KEY ([SalesOrderID]) REFERENCES [SalesLT].[SalesOrderHeader] ([SalesOrderID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
